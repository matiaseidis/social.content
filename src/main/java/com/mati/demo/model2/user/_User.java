package com.mati.demo.model2.user;
...
public abstract class _User extends Taggable implements Followable, Follower{
	...
	private Map<String, _User> followedBy = new HashMap<String, _User>();
	
	private Map<String, _User> followedUsers = new HashMap<String, _User>();
...
//		tag.removeTagged(this);
	 ...
	 */
	public void startFollowing(_User follower) {
		followedBy.put(follower.getUserName(), follower);
	}

	public void stopFollowing(_User follower) {
	...
	public void addFollower(_User user) {
